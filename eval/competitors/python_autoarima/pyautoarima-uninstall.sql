...
DROP FUNCTION IF EXISTS pyautoarima_full_table_state(DOUBLE PRECISION[],DOUBLE PRECISION[],DOUBLE PRECISION[],DOUBLE PRECISION,INT,INT,INT);
...
-- Drop types
DROP TYPE IF EXISTS pyautoarima_fit_result CASCADE;
DROP TYPE IF EXISTS pyautoarima_incremental_state CASCADE;
